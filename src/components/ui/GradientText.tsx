...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative inline-flex flex-row items-center justify-center font-medium overflow-hidden ${showBorder ? 'py-1 px-2 rounded-[1.25rem]' : ''} ${className}`}
